...
#include "FluidDynamicTooltikModeEditorMode.generated.h"
 ...
 */
UCLASS()
class UFluidDynamicTooltikModeEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_FluidDynamicTooltikModeEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UFluidDynamicTooltikModeEditorMode();
	virtual ~UFluidDynamicTooltikModeEditorMode();
