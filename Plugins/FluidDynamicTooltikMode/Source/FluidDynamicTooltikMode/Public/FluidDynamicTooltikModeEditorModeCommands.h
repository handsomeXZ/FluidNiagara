 ...
 */
class FFluidDynamicTooltikModeEditorModeCommands : public TCommands<FFluidDynamicTooltikModeEditorModeCommands>
{
public:
	FFluidDynamicTooltikModeEditorModeCommands();
