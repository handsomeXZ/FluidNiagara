...
#include "FluidDynamicTooltikModeInteractiveTool.generated.h"


/**
 * Builder for UFluidDynamicTooltikModeInteractiveTool
 */
UCLASS()
class FLUIDDYNAMICTOOLTIKMODE_API UFluidDynamicTooltikModeInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UFluidDynamicTooltikModeInteractiveTool
 */
UCLASS(Transient)
class FLUIDDYNAMICTOOLTIKMODE_API UFluidDynamicTooltikModeInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UFluidDynamicTooltikModeInteractiveToolProperties();
...
/**
 * UFluidDynamicTooltikModeInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class FLUIDDYNAMICTOOLTIKMODE_API UFluidDynamicTooltikModeInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UFluidDynamicTooltikModeInteractiveToolProperties> Properties;
