...
#include "FluidDynamicTooltikModeInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UFluidDynamicTooltikModeInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UFluidDynamicTooltikModeInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UFluidDynamicTooltikModeInteractiveTool* NewTool = NewObject<UFluidDynamicTooltikModeInteractiveTool>(SceneState.ToolManager);
...
UFluidDynamicTooltikModeInteractiveToolProperties::UFluidDynamicTooltikModeInteractiveToolProperties()
{
...
void UFluidDynamicTooltikModeInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UFluidDynamicTooltikModeInteractiveTool::Setup()
{
	...
	Properties = NewObject<UFluidDynamicTooltikModeInteractiveToolProperties>(this, "Measurement");
...
void UFluidDynamicTooltikModeInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UFluidDynamicTooltikModeInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UFluidDynamicTooltikModeInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UFluidDynamicTooltikModeInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UFluidDynamicTooltikModeInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UFluidDynamicTooltikModeInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UFluidDynamicTooltikModeInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UFluidDynamicTooltikModeInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UFluidDynamicTooltikModeInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
