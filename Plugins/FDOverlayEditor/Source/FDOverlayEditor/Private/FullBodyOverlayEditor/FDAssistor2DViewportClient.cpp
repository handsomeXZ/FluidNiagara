...
namespace FFDAssistor2DViewportClientLocals {
...
FFDAssistor2DViewportClient::FFDAssistor2DViewportClient(FEditorModeTools* InModeTools,
	...
	UFDAssistorLive2DViewportAPI* live2DViewportAPIIn)
...
bool FFDAssistor2DViewportClient::InputKey(const FInputKeyEventArgs& EventArgs)
{
...
bool FFDAssistor2DViewportClient::ShouldOrbitCamera() const
{
	return false; // The UV Editor's 2D viewport should never orbit.
}

void FFDAssistor2DViewportClient::SetWidgetMode(UE::Widget::EWidgetMode NewMode)
{
	if (ViewportButtonsAPI)
	{
		...
		case UE::Widget::EWidgetMode::WM_None:
			ViewportButtonsAPI->SetGizmoMode(UFDAssistorViewportButtonsAPI::EGizmoMode::Select);
			break;
		case UE::Widget::EWidgetMode::WM_Translate:
			ViewportButtonsAPI->SetGizmoMode(UFDAssistorViewportButtonsAPI::EGizmoMode::Transform);
			break;
		default:
			// Do nothing
			break;
...
bool FFDAssistor2DViewportClient::AreWidgetButtonsEnabled() const
{
	return ViewportButtonsAPI && ViewportButtonsAPI->AreGizmoButtonsEnabled();
}

void FFDAssistor2DViewportClient::SetLocationGridSnapEnabled(bool bEnabled)
{
	ViewportButtonsAPI->ToggleSnapEnabled(UFDAssistorViewportButtonsAPI::ESnapTypeFlag::Location);
}

bool FFDAssistor2DViewportClient::GetLocationGridSnapEnabled()
{
	return ViewportButtonsAPI->GetSnapEnabled(UFDAssistorViewportButtonsAPI::ESnapTypeFlag::Location);
}

void FFDAssistor2DViewportClient::SetLocationGridSnapValue(float SnapValue)
{
	ViewportButtonsAPI->SetSnapValue(UFDAssistorViewportButtonsAPI::ESnapTypeFlag::Location, SnapValue);
}

float FFDAssistor2DViewportClient::GetLocationGridSnapValue()
{
	return 	ViewportButtonsAPI->GetSnapValue(UFDAssistorViewportButtonsAPI::ESnapTypeFlag::Location);
}

void FFDAssistor2DViewportClient::SetRotationGridSnapEnabled(bool bEnabled)
{
	ViewportButtonsAPI->ToggleSnapEnabled(UFDAssistorViewportButtonsAPI::ESnapTypeFlag::Rotation);
}

bool FFDAssistor2DViewportClient::GetRotationGridSnapEnabled()
{
	return ViewportButtonsAPI->GetSnapEnabled(UFDAssistorViewportButtonsAPI::ESnapTypeFlag::Rotation);
}

void FFDAssistor2DViewportClient::SetRotationGridSnapValue(float SnapValue)
{
	ViewportButtonsAPI->SetSnapValue(UFDAssistorViewportButtonsAPI::ESnapTypeFlag::Rotation, SnapValue);
}

float FFDAssistor2DViewportClient::GetRotationGridSnapValue()
{
	return ViewportButtonsAPI->GetSnapValue(UFDAssistorViewportButtonsAPI::ESnapTypeFlag::Rotation);
}

void FFDAssistor2DViewportClient::SetScaleGridSnapEnabled(bool bEnabled)
{
	ViewportButtonsAPI->ToggleSnapEnabled(UFDAssistorViewportButtonsAPI::ESnapTypeFlag::Scale);
}

bool FFDAssistor2DViewportClient::GetScaleGridSnapEnabled()
{
	return ViewportButtonsAPI->GetSnapEnabled(UFDAssistorViewportButtonsAPI::ESnapTypeFlag::Scale);
}

void FFDAssistor2DViewportClient::SetScaleGridSnapValue(float SnapValue)
{
	ViewportButtonsAPI->SetSnapValue(UFDAssistorViewportButtonsAPI::ESnapTypeFlag::Scale, SnapValue);
}

float FFDAssistor2DViewportClient::GetScaleGridSnapValue()
{
	return ViewportButtonsAPI->GetSnapValue(UFDAssistorViewportButtonsAPI::ESnapTypeFlag::Scale);
}

bool FFDAssistor2DViewportClient::AreSelectionButtonsEnabled() const
{
	return ViewportButtonsAPI && ViewportButtonsAPI->AreSelectionButtonsEnabled();
}

bool FFDAssistor2DViewportClient::CanSetWidgetMode(UE::Widget::EWidgetMode NewMode) const
{
...
UE::Widget::EWidgetMode FFDAssistor2DViewportClient::GetWidgetMode() const
{
	if (!AreWidgetButtonsEnabled())
	{
	...
	{
	case UFDAssistorViewportButtonsAPI::EGizmoMode::Select:
		return UE::Widget::EWidgetMode::WM_None;
		break;
	case UFDAssistorViewportButtonsAPI::EGizmoMode::Transform:
...
UFDAssistorViewportButtonsAPI::ESelectionMode FFDAssistor2DViewportClient::GetSelectionMode() const
{
	if (!AreSelectionButtonsEnabled())
	{
		return UFDAssistorViewportButtonsAPI::ESelectionMode::None;
	}
