...
#include "FDOverlayEditorInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UFDOverlayEditorInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UFDOverlayEditorInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UFDOverlayEditorInteractiveTool* NewTool = NewObject<UFDOverlayEditorInteractiveTool>(SceneState.ToolManager);
...
UFDOverlayEditorInteractiveToolProperties::UFDOverlayEditorInteractiveToolProperties()
{
...
void UFDOverlayEditorInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UFDOverlayEditorInteractiveTool::Setup()
{
	...
	Properties = NewObject<UFDOverlayEditorInteractiveToolProperties>(this, "Measurement");
...
void UFDOverlayEditorInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UFDOverlayEditorInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UFDOverlayEditorInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UFDOverlayEditorInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UFDOverlayEditorInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UFDOverlayEditorInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UFDOverlayEditorInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UFDOverlayEditorInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UFDOverlayEditorInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
