...
#include "FDOverlayEditorInteractiveTool.generated.h"


/**
 * Builder for UFDOverlayEditorInteractiveTool
 */
UCLASS()
class FDOVERLAYEDITOR_API UFDOverlayEditorInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UFDOverlayEditorInteractiveTool
 */
UCLASS(Transient)
class FDOVERLAYEDITOR_API UFDOverlayEditorInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UFDOverlayEditorInteractiveToolProperties();
...
/**
 * UFDOverlayEditorInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class FDOVERLAYEDITOR_API UFDOverlayEditorInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UFDOverlayEditorInteractiveToolProperties> Properties;
