...
#include "Selection/FDAssistorSelectionAPI.h"

#include "FDAssistorViewportButtonsAPI.generated.h"

/**
 * Allows tools to interact with buttons in the viewport
 */
UCLASS()
class FDASSISTOR_API UFDAssistorViewportButtonsAPI : public UFDAssistorContextObject
{
	GENERATED_BODY()
public:
	...
	using ESelectionMode = UFDAssistorSelectionAPI::EFDEditorSelectionMode;
