...
#include "Context/Selection/FDAssistorSelection.h"

#include "FDAssistorSelectionAPI.generated.h"
 ...
 */
UCLASS()
class FDASSISTOR_API UFDAssistorSelectionAPI : public UFDAssistorContextObject
{
	GENERATED_BODY()
public:
