...
#include "FluidNDIGrid2DCollection.h"
...
#include "Core\Public\Serialization\MemoryLayout.h"

//#include UE_INLINE_GENERATED_CPP_BY_NAME(NiagaraDataInterfaceGrid2DCollection)

#define LOCTEXT_NAMESPACE "FluidNDIGrid2DCollection"

IMPLEMENT_TYPE_LAYOUT(FFluidNDIParametersCS_Grid2DCollection);
...
const FString UFluidNDIGrid2DCollection::GridName(TEXT("_Grid"));
const FString UFluidNDIGrid2DCollection::OutputGridName(TEXT("_OutputGrid"));
const FString UFluidNDIGrid2DCollection::SamplerName(TEXT("_GridSampler"));

const FName UFluidNDIGrid2DCollection::SetNumCellsFunctionName("SetNumCells");

// Global VM function names, also used by the shaders code generation methods.
const FName UFluidNDIGrid2DCollection::SetValueFunctionName("SetGridValue");
const FName UFluidNDIGrid2DCollection::GetValueFunctionName("GetGridValue");
const FName UFluidNDIGrid2DCollection::SetVector4ValueFunctionName("SetVector4Value");	
const FName UFluidNDIGrid2DCollection::GetVector4ValueFunctionName("GetVector4Value");
const FName UFluidNDIGrid2DCollection::SampleGridVector4FunctionName("SampleGridVector4Value");
const FName UFluidNDIGrid2DCollection::SetVector3ValueFunctionName("SetVector3Value");
const FName UFluidNDIGrid2DCollection::GetVector3ValueFunctionName("GetVector3Value");
const FName UFluidNDIGrid2DCollection::SampleGridVector3FunctionName("SampleGridVector3Value");
const FName UFluidNDIGrid2DCollection::SetVector2ValueFunctionName("SetVector2Value");
const FName UFluidNDIGrid2DCollection::GetVector2ValueFunctionName("GetVector2Value");
const FName UFluidNDIGrid2DCollection::SampleGridVector2FunctionName("SampleGridVector2Value");
const FName UFluidNDIGrid2DCollection::SetFloatValueFunctionName("SetFloatValue");
const FName UFluidNDIGrid2DCollection::GetFloatValueFunctionName("GetFloatValue");
const FName UFluidNDIGrid2DCollection::SampleGridFloatFunctionName("SampleGridFloatValue");

const FName UFluidNDIGrid2DCollection::SetValueAtIndexFunctionName("SetValueAtIndex");
const FName UFluidNDIGrid2DCollection::GetPreviousValueAtIndexFunctionName("GetPreviousValueAtIndex");
const FName UFluidNDIGrid2DCollection::SamplePreviousGridAtIndexFunctionName("SamplePreviousGridAtIndex");

const FName UFluidNDIGrid2DCollection::GetPreviousVector4ValueFunctionName("GetPreviousVector4Value");
const FName UFluidNDIGrid2DCollection::SamplePreviousGridVector4FunctionName("SamplePreviousGridVector4Value");
const FName UFluidNDIGrid2DCollection::SetVectorValueFunctionName("SetVectorValue");
const FName UFluidNDIGrid2DCollection::GetPreviousVectorValueFunctionName("GetPreviousVectorValue");
const FName UFluidNDIGrid2DCollection::SamplePreviousGridVectorFunctionName("SamplePreviousGridVector3Value");
const FName UFluidNDIGrid2DCollection::SetVector2DValueFunctionName("SetVector2DValue");
const FName UFluidNDIGrid2DCollection::GetPreviousVector2DValueFunctionName("GetPreviousVector2DValue");
const FName UFluidNDIGrid2DCollection::SamplePreviousGridVector2DFunctionName("SamplePreviousGridVector2DValue");
const FName UFluidNDIGrid2DCollection::GetPreviousFloatValueFunctionName("GetPreviousFloatValue");
const FName UFluidNDIGrid2DCollection::SamplePreviousGridFloatFunctionName("SamplePreviousGridFloatValue");

const FName UFluidNDIGrid2DCollection::GetVector4AttributeIndexFunctionName("GetVector4AttributeIndex");
const FName UFluidNDIGrid2DCollection::GetVectorAttributeIndexFunctionName("GetVectorAttributeIndex");
const FName UFluidNDIGrid2DCollection::GetVector2DAttributeIndexFunctionName("GetVector2DAttributeIndex");
const FName UFluidNDIGrid2DCollection::GetFloatAttributeIndexFunctionName("GetFloatAttributeIndex");

const FString UFluidNDIGrid2DCollection::AnonymousAttributeString("Attribute At Index");

const FName UFluidNDIGrid2DCollection::ClearCellFunctionName("ClearCell");
const FName UFluidNDIGrid2DCollection::CopyPreviousToCurrentForCellFunctionName("CopyPreviousToCurrentForCell");

const FString UFluidNDIGrid2DCollection::AttributeIndicesBaseName(TEXT("AttributeIndices"));
const TCHAR* UFluidNDIGrid2DCollection::VectorComponentNames[] = { TEXT(".x"), TEXT(".y"), TEXT(".z"), TEXT(".w") };
...
UFluidNDIGrid2DCollection::UFluidNDIGrid2DCollection(FObjectInitializer const& ObjectInitializer)
	: Super(ObjectInitializer), OverrideBufferFormat(ENiagaraGpuBufferFormat::Float), bOverrideFormat(false)
#if WITH_EDITORONLY_DATA
	, bPreviewGrid(false)
#endif
{
	Proxy.Reset(new FFluidNDIProxyGrid2DCollectionProxy());
...
void UFluidNDIGrid2DCollection::PostInitProperties()
{
	...
	if (HasAnyFlags(RF_ClassDefaultObject))
	{
		...
		UFluidNDIGrid2DCollection::ExposedRTVar = FNiagaraVariableBase(FNiagaraTypeDefinition(UTexture::StaticClass()), TEXT("RenderTarget"));
	}
}

#if WITH_EDITORONLY_DATA
bool UFluidNDIGrid2DCollection::AppendCompileHash(FNiagaraCompileHashVisitor* InVisitor) const
{
	if (!Super::AppendCompileHash(InVisitor))
		return false;


	InVisitor->UpdatePOD(TEXT("UFluidNDIGrid2DCollectionVersion"), (int32)FNiagaraGridCollection2DDIFunctionVersion::LatestVersion);
...
#if WITH_EDITOR
void UFluidNDIGrid2DCollection::GetFeedback(UNiagaraSystem* Asset, UNiagaraComponent* Component, TArray<FNiagaraDataInterfaceError>& OutErrors,
...
#if WITH_EDITORONLY_DATA
bool UFluidNDIGrid2DCollection::UpgradeFunctionCall(FNiagaraFunctionSignature& FunctionSignature)
{
...
void UFluidNDIGrid2DCollection::GetFunctions(TArray<FNiagaraFunctionSignature>& OutFunctions)
{
...
DEFINE_NDI_DIRECT_FUNC_BINDER(UFluidNDIGrid2DCollection, VMGetWorldBBoxSize);
DEFINE_NDI_DIRECT_FUNC_BINDER(UFluidNDIGrid2DCollection, VMGetCellSize);
DEFINE_NDI_DIRECT_FUNC_BINDER(UFluidNDIGrid2DCollection, VMGetNumCells);
DEFINE_NDI_DIRECT_FUNC_BINDER(UFluidNDIGrid2DCollection, VMSetNumCells);
DEFINE_NDI_DIRECT_FUNC_BINDER_WITH_PAYLOAD(UFluidNDIGrid2DCollection, VMGetAttributeIndex);
void UFluidNDIGrid2DCollection::GetVMExternalFunction(const FVMExternalFunctionBindingInfo& BindingInfo, void* InstanceData, FVMExternalFunction &OutFunc)
{
	...
	if (BindingInfo.Name == UNiagaraDataInterfaceRWBase::WorldBBoxSizeFunctionName)
	{
		...
		NDI_FUNC_BINDER(UFluidNDIGrid2DCollection, VMGetWorldBBoxSize)::Bind(this, OutFunc);
	}
	else if (BindingInfo.Name == UNiagaraDataInterfaceRWBase::CellSizeFunctionName)
	{
		...
		check(BindingInfo.GetNumInputs() == 1 && BindingInfo.GetNumOutputs() == 2);
		NDI_FUNC_BINDER(UFluidNDIGrid2DCollection, VMGetCellSize)::Bind(this, OutFunc);
	}
	else if (BindingInfo.Name == UNiagaraDataInterfaceRWBase::NumCellsFunctionName)
	{
		...
		// it would be nice to refactor this so it can be part of the super class
		check(BindingInfo.GetNumInputs() == 1 && BindingInfo.GetNumOutputs() == 2);
		NDI_FUNC_BINDER(UFluidNDIGrid2DCollection, VMGetNumCells)::Bind(this, OutFunc);
	}
	else if (BindingInfo.Name == SetNumCellsFunctionName)
	{
		check(BindingInfo.GetNumInputs() == 3 && BindingInfo.GetNumOutputs() == 1);
		NDI_FUNC_BINDER(UFluidNDIGrid2DCollection, VMSetNumCells)::Bind(this, OutFunc);
	}
	...
	else if (BindingInfo.Name == GetVector4AttributeIndexFunctionName)
	{
		...
		NDI_FUNC_BINDER(UFluidNDIGrid2DCollection, VMGetAttributeIndex)::Bind(this, OutFunc, AttributeName, 4);
	}
	else if (BindingInfo.Name == GetVectorAttributeIndexFunctionName)
	{
		FName AttributeName = BindingInfo.FindSpecifier(NAME_Attribute)->Value;
		check(BindingInfo.GetNumInputs() == 1 && BindingInfo.GetNumOutputs() == 1);
		NDI_FUNC_BINDER(UFluidNDIGrid2DCollection, VMGetAttributeIndex)::Bind(this, OutFunc, AttributeName, 3);
	}
	else if (BindingInfo.Name == GetVector2DAttributeIndexFunctionName)
	{
		FName AttributeName = BindingInfo.FindSpecifier(NAME_Attribute)->Value;
		check(BindingInfo.GetNumInputs() == 1 && BindingInfo.GetNumOutputs() == 1);
		NDI_FUNC_BINDER(UFluidNDIGrid2DCollection, VMGetAttributeIndex)::Bind(this, OutFunc, AttributeName, 2);
	}
	else if (BindingInfo.Name == GetFloatAttributeIndexFunctionName)
	{
		FName AttributeName = BindingInfo.FindSpecifier(NAME_Attribute)->Value;
		check(BindingInfo.GetNumInputs() == 1 && BindingInfo.GetNumOutputs() == 1);
		NDI_FUNC_BINDER(UFluidNDIGrid2DCollection, VMGetAttributeIndex)::Bind(this, OutFunc, AttributeName, 1);
	}
}

bool UFluidNDIGrid2DCollection::Equals(const UNiagaraDataInterface* Other) const
{
	if (!Super::Equals(Other))
	{
		return false;
	}
	const UFluidNDIGrid2DCollection* OtherTyped = CastChecked<const UFluidNDIGrid2DCollection>(Other);
...
#if WITH_EDITORONLY_DATA
void UFluidNDIGrid2DCollection::GetParameterDefinitionHLSL(const FNiagaraDataInterfaceGPUParamInfo& ParamInfo, FString& OutHLSL)
{
...
void UFluidNDIGrid2DCollection::WriteSetHLSL(const FNiagaraDataInterfaceGPUParamInfo& ParamInfo, const FNiagaraDataInterfaceGeneratedFunction& FunctionInfo, int FunctionInstanceIndex, int32 InNumChannels, FString& OutHLSL)
{
...
void UFluidNDIGrid2DCollection::WriteGetHLSL(const FNiagaraDataInterfaceGPUParamInfo& ParamInfo, const FNiagaraDataInterfaceGeneratedFunction& FunctionInfo, int FunctionInstanceIndex, int32 InNumChannels, FString& OutHLSL)
{
...
void UFluidNDIGrid2DCollection::WriteSampleHLSL(const FNiagaraDataInterfaceGPUParamInfo& ParamInfo, const FNiagaraDataInterfaceGeneratedFunction& FunctionInfo, int FunctionInstanceIndex, int32 InNumChannels, FString& OutHLSL)
{
	FString FormatBounds = TEXT(R"(
...
void UFluidNDIGrid2DCollection::WriteAttributeGetIndexHLSL(const FNiagaraDataInterfaceGPUParamInfo& ParamInfo, const FNiagaraDataInterfaceGeneratedFunction& FunctionInfo, int FunctionInstanceIndex, int32 InNumChannels, FString& OutHLSL)
{
	FString FormatBounds = TEXT(R"(
...
const TCHAR* UFluidNDIGrid2DCollection::TypeDefinitionToHLSLTypeString(const FNiagaraTypeDefinition& InDef) const
{
...
FName UFluidNDIGrid2DCollection::TypeDefinitionToGetFunctionName(const FNiagaraTypeDefinition& InDef) const
{
	if (InDef == FNiagaraTypeDefinition::GetFloatDef())
...
FName UFluidNDIGrid2DCollection::TypeDefinitionToSetFunctionName(const FNiagaraTypeDefinition& InDef) const
{
	if (InDef == FNiagaraTypeDefinition::GetFloatDef())
...
bool UFluidNDIGrid2DCollection::GetFunctionHLSL(const FNiagaraDataInterfaceGPUParamInfo& ParamInfo, const FNiagaraDataInterfaceGeneratedFunction& FunctionInfo, int FunctionInstanceIndex, FString& OutHLSL)
{
...
void UFluidNDIGrid2DCollection::BuildShaderParameters(FNiagaraShaderParametersBuilder& ShaderParametersBuilder) const
{
	...
	ShaderParametersBuilder.AddLooseParamArray<FIntVector4>(*UFluidNDIGrid2DCollection::AttributeIndicesBaseName, IndirectionTableSize);
}

void UFluidNDIGrid2DCollection::SetShaderParameters(const FNiagaraDataInterfaceSetShaderParametersContext& Context) const
{
	FFluidNDIProxyGrid2DCollectionProxy& DIProxy = Context.GetProxy<FFluidNDIProxyGrid2DCollectionProxy>();
	FFluidGrid2DCollectionRWInstanceData_RenderThread* ProxyData = DIProxy.SystemInstancesToProxyData_RT.Find(Context.GetSystemInstanceID());
	FFluidGrid2DCollectionRWInstanceData_RenderThread* OriginalProxyData = ProxyData;
	check(ProxyData);

	if (ProxyData->OtherProxy != nullptr)
	{
		FFluidNDIProxyGrid2DCollectionProxy* OtherGrid3DProxy = static_cast<FFluidNDIProxyGrid2DCollectionProxy*>(ProxyData->OtherProxy);
		ProxyData = OtherGrid3DProxy->SystemInstancesToProxyData_RT.Find(Context.GetSystemInstanceID());
		check(ProxyData);
	}

	const FFluidNDIParametersCS_Grid2DCollection& ShaderStorage = Context.GetShaderStorage<FFluidNDIParametersCS_Grid2DCollection>();
...
FNiagaraDataInterfaceParametersCS* UFluidNDIGrid2DCollection::CreateShaderStorage(const FNiagaraDataInterfaceGPUParamInfo& ParameterInfo, const FShaderParameterMap& ParameterMap) const
{
	FFluidNDIParametersCS_Grid2DCollection* ShaderStorage = new FFluidNDIParametersCS_Grid2DCollection();
	...
	for (int32 FuncIdx=0; FuncIdx < NumFuncs; ++FuncIdx)
	{
		...
		{
			int32 ComponentCount = UFluidNDIGrid2DCollection::GetComponentCountFromFuncName(Func.DefinitionName);
...
const FTypeLayoutDesc* UFluidNDIGrid2DCollection::GetShaderStorageType() const
{
	return &StaticGetTypeLayoutDesc<FFluidNDIParametersCS_Grid2DCollection>();
}

#if WITH_EDITOR
bool UFluidNDIGrid2DCollection::GenerateIterationSourceNamespaceReadAttributesHLSL(FNiagaraDataInterfaceGPUParamInfo& DIInstanceInfo, const FNiagaraVariable& IterationSourceVar, TConstArrayView<FNiagaraVariable> InArguments, TConstArrayView<FNiagaraVariable> InAttributes, TConstArrayView<FString> InAttributeHLSLNames, bool bInSetToDefaults, bool bSpawnOnly, bool bPartialWrites, TArray<FText>& OutErrors, FString& OutHLSL) const
{

	FString DIVarName;
	OutHLSL += TEXT("\t//Generated by UFluidNDIGrid2DCollection::GenerateIterationSourceNamespaceReadAttributesHLSL\n");
...
bool UFluidNDIGrid2DCollection::GenerateSetupHLSL(FNiagaraDataInterfaceGPUParamInfo& DIInstanceInfo, TConstArrayView<FNiagaraVariable> InArguments, bool bSpawnOnly, bool bPartialWrites, TArray<FText>& OutErrors, FString& OutHLSL) const
{
	FString DIVarName;
	OutHLSL += TEXT("\t//Generated by UFluidNDIGrid2DCollection::GenerateSetupHLSL\n");
	for (int32 i = 0; i < InArguments.Num(); i++)
	{
		OutHLSL += FString::Printf(TEXT("\t// Argument Name \"%s\" Type \"%s\"\n"), *InArguments[i].GetName().ToString(), *InArguments[i].GetType().GetName());
...
bool UFluidNDIGrid2DCollection::GenerateTeardownHLSL(FNiagaraDataInterfaceGPUParamInfo& DIInstanceInfo, TConstArrayView<FNiagaraVariable> InArguments, bool bSpawnOnly, bool bPartialWrites, TArray<FText>& OutErrors, FString& OutHLSL) const
{
	OutHLSL += TEXT("\t//Generated by UFluidNDIGrid2DCollection::GenerateTeardownHLSL\n");


	return true;
}
#endif
bool UFluidNDIGrid2DCollection::CopyToInternal(UNiagaraDataInterface* Destination) const
{
	...
	UFluidNDIGrid2DCollection* OtherTyped = CastChecked<UFluidNDIGrid2DCollection>(Destination);
	OtherTyped->RenderTargetUserParameter = RenderTargetUserParameter;
	OtherTyped->OverrideBufferFormat = OverrideBufferFormat;
	OtherTyped->bOverrideFormat = bOverrideFormat;
#if WITH_EDITORONLY_DATA
...
bool UFluidNDIGrid2DCollection::InitPerInstanceData(void* PerInstanceData, FNiagaraSystemInstance* SystemInstance)
{
	check(Proxy);

	FFluidGrid2DCollectionRWInstanceData_GameThread* InstanceData = new (PerInstanceData) FFluidGrid2DCollectionRWInstanceData_GameThread();
	...
	if (bPreviewGrid && !PreviewAttribute.IsNone())
	{
		...
		{
			UE_LOG(LogTemp, Warning, TEXT("Failed to map PreviewAttribute %s to a grid index"), *PreviewAttribute.ToString());
		}
	}
#endif

	// Push Updates to Proxy.
	FFluidNDIProxyGrid2DCollectionProxy* RT_Proxy = GetProxyAs<FFluidNDIProxyGrid2DCollectionProxy>();
		...
		[RT_Resource=InstanceData->TargetTexture ? InstanceData->TargetTexture->GetResource() : nullptr, RT_Proxy, InstanceID=SystemInstance->GetId(), RT_InstanceData=*InstanceData](FRHICommandListImmediate& RHICmdList)
	{
		...
		FFluidGrid2DCollectionRWInstanceData_RenderThread* TargetData = &RT_Proxy->SystemInstancesToProxyData_RT.Add(InstanceID);
...
void UFluidNDIGrid2DCollection::DestroyPerInstanceData(void* PerInstanceData, FNiagaraSystemInstance* SystemInstance)
{
	SystemInstancesToProxyData_GT.Remove(SystemInstance->GetId());

	FFluidGrid2DCollectionRWInstanceData_GameThread* InstanceData = static_cast<FFluidGrid2DCollectionRWInstanceData_GameThread*>(PerInstanceData);

	InstanceData->~FFluidGrid2DCollectionRWInstanceData_GameThread();
...
bool UFluidNDIGrid2DCollection::PerInstanceTick(void* PerInstanceData, FNiagaraSystemInstance* SystemInstance, float DeltaSeconds)
{
	FFluidGrid2DCollectionRWInstanceData_GameThread* InstanceData = SystemInstancesToProxyData_GT.FindRef(SystemInstance->GetId());
	...
	{
		FFluidGrid2DCollectionRWInstanceData_RenderThread* TargetData = RT_Proxy->SystemInstancesToProxyData_RT.Find(InstanceID);
		if (RT_Resource && RT_Resource->TextureRHI.IsValid())
		{
			TargetData->RenderTargetToCopyTo = RT_Resource->TextureRHI;
		}
...
void UFluidNDIGrid2DCollection::GetExposedVariables(TArray<FNiagaraVariableBase>& OutVariables) const
{
	OutVariables.Emplace(ExposedRTVar);
}

bool UFluidNDIGrid2DCollection::GetExposedVariableValue(const FNiagaraVariableBase& InVariable, void* InPerInstanceData, FNiagaraSystemInstance* InSystemInstance, void* OutData) const
{
	FFluidGrid2DCollectionRWInstanceData_GameThread* InstanceData = static_cast<FFluidGrid2DCollectionRWInstanceData_GameThread*>(InPerInstanceData);
...
void UFluidNDIGrid2DCollection::CollectAttributesForScript(UNiagaraScript* Script, FName VariableName, TArray<FNiagaraVariableBase>& OutVariables, TArray<uint32>& OutVariableOffsets, int32& TotalAttributes, TArray<FText>* OutWarnings)
{
	...
	{
		const FNiagaraVariableBase DataInterfaceVariable(FNiagaraTypeDefinition(UFluidNDIGrid2DCollection::StaticClass()), VariableName);
		...
		if (IndexOfDataInterface != nullptr)
		{
			...
			for (const FNiagaraDataInterfaceGeneratedFunction& Func : ParamInfoArray[*IndexOfDataInterface].GeneratedFunctions)
			{
				...
				{
					FNiagaraVariableBase NewVar(UFluidNDIGrid2DCollection::GetValueTypeFromFuncName(Func.DefinitionName), *AttributeName);
					if (UFluidNDIGrid2DCollection::CanCreateVarFromFuncName(Func.DefinitionName))
					{
...
void UFluidNDIGrid2DCollection::FindAttributesByName(FName VariableName, TArray<FNiagaraVariableBase>& OutVariables, TArray<uint32>& OutVariableOffsets, int32& OutNumAttribChannelsFound, TArray<FText>* OutWarnings) const
{
...
void UFluidNDIGrid2DCollection::FindAttributes(TArray<FNiagaraVariableBase>& OutVariables, TArray<uint32>& OutVariableOffsets, int32& OutNumAttribChannelsFound, TArray<FText>* OutWarnings) const
{
	OutNumAttribChannelsFound = 0;
...
void UFluidNDIGrid2DCollection::GetCanvasVariables(TArray<FNiagaraVariableBase>& OutVariables) const
{
...
bool UFluidNDIGrid2DCollection::RenderVariableToCanvas(FNiagaraSystemInstanceID SystemInstanceID, FName VariableName, class FCanvas* Canvas, const FIntRect& DrawRect) const
{
	if (!Canvas)
	{
		return false;
	...
	FFluidGrid2DCollectionRWInstanceData_GameThread* Grid2DInstanceData = SystemInstancesToProxyData_GT.FindRef(SystemInstanceID);
	...
	TileItem.BatchedElementParameters = new FBatchedElementNiagara2DArrayAttribute(
		AttributeSlices,
		[RT_Proxy=GetProxyAs<FFluidNDIProxyGrid2DCollectionProxy>(), RT_SystemInstanceID=SystemInstanceID](FRHITexture*& OutTexture, FRHISamplerState*& OutSamplerState)
		{
			if ( const FFluidGrid2DCollectionRWInstanceData_RenderThread* RT_InstanceData = RT_Proxy->SystemInstancesToProxyData_RT.Find(RT_SystemInstanceID) )
			{
...
bool UFluidNDIGrid2DCollection::FillTexture2D(const UNiagaraComponent *Component, UTextureRenderTarget2D *Dest, int AttributeIndex)
{
	if (!Component || !Dest)
	{
		return false;
	...
	{
		FFluidGrid2DCollectionRWInstanceData_RenderThread* Grid2DInstanceData = RT_Proxy->SystemInstancesToProxyData_RT.Find(InstanceID);
...
bool UFluidNDIGrid2DCollection::FillRawTexture2D(const UNiagaraComponent *Component, UTextureRenderTarget2D *Dest, int &TilesX, int &TilesY)
{
	if (!Component)
	{
		TilesX = -1;
	...
	FFluidGrid2DCollectionRWInstanceData_GameThread* Grid2DInstanceData = SystemInstancesToProxyData_GT.FindRef(SystemID);
	if (!Grid2DInstanceData)
	{
		TilesX = -1;
		TilesY = -1;
	...
	{
		FFluidGrid2DCollectionRWInstanceData_RenderThread* RT_Grid2DInstanceData = RT_Proxy->SystemInstancesToProxyData_RT.Find(RT_InstanceID);
...
void UFluidNDIGrid2DCollection::GetRawTextureSize(const UNiagaraComponent *Component, int &SizeX, int &SizeY)
{
	if (!Component)
	{
		SizeX = -1;
	...
	FFluidGrid2DCollectionRWInstanceData_GameThread* Grid2DInstanceData = SystemInstancesToProxyData_GT.FindRef(InstanceID);
	if (!Grid2DInstanceData)
	{
		SizeX = -1;
		SizeY = -1;
...
void UFluidNDIGrid2DCollection::GetTextureSize(const UNiagaraComponent *Component, int &SizeX, int &SizeY)
{
	if (!Component)
	{
		SizeX = -1;
...
void UFluidNDIGrid2DCollection::VMGetWorldBBoxSize(FVectorVMExternalFunctionContext& Context)
{
	VectorVM::FUserPtrHandler<FFluidGrid2DCollectionRWInstanceData_GameThread> InstData(Context);
...
void UFluidNDIGrid2DCollection::VMGetCellSize(FVectorVMExternalFunctionContext& Context)
{
	VectorVM::FUserPtrHandler<FFluidGrid2DCollectionRWInstanceData_GameThread> InstData(Context);
...
void UFluidNDIGrid2DCollection::VMGetNumCells(FVectorVMExternalFunctionContext& Context)
{
	VectorVM::FUserPtrHandler<FFluidGrid2DCollectionRWInstanceData_GameThread> InstData(Context);
...
void UFluidNDIGrid2DCollection::VMSetNumCells(FVectorVMExternalFunctionContext& Context)
{
...
bool UFluidNDIGrid2DCollection::PerInstanceTickPostSimulate(void* PerInstanceData, FNiagaraSystemInstance* SystemInstance, float DeltaSeconds)
{
	FFluidGrid2DCollectionRWInstanceData_GameThread* InstanceData = static_cast<FFluidGrid2DCollectionRWInstanceData_GameThread*>(PerInstanceData);
...
void UFluidNDIGrid2DCollection::VMGetAttributeIndex(FVectorVMExternalFunctionContext& Context, const FName& InName, int32 NumChannels)
{
	VectorVM::FUserPtrHandler<FFluidGrid2DCollectionRWInstanceData_GameThread> InstData(Context);
...
int32 FFluidGrid2DCollectionRWInstanceData_GameThread::FindAttributeIndexByName(const FName& InName, int32 NumChannels)
{
...
bool FFluidGrid2DCollectionRWInstanceData_GameThread::UpdateTargetTexture(ENiagaraGpuBufferFormat BufferFormat)
{
	...
	if (UObject* UserParamObject = RTUserParamBinding.GetValue())
	{
		...
		{
			UE_LOG(LogTemp, Error, TEXT("RenderTarget UserParam is a '%s' but is expected to be a UTextureRenderTarget2DArray or UTextureRenderTarget2D"), *GetNameSafe(UserParamObject->GetClass()));
		}
	}
...
void FFluidGrid2DCollectionRWInstanceData_RenderThread::BeginSimulate(FRDGBuilder& GraphBuilder)
{
...
void FFluidGrid2DCollectionRWInstanceData_RenderThread::EndSimulate()
{
	CurrentData = DestinationData;
	DestinationData = nullptr;
}

void FFluidNDIProxyGrid2DCollectionProxy::ResetData(const FNDIGpuComputeResetContext& Context)
{
	FFluidGrid2DCollectionRWInstanceData_RenderThread* ProxyData = SystemInstancesToProxyData_RT.Find(Context.GetSystemInstanceID());
	if (!ProxyData)
	{
		return;
	}
...
void FFluidNDIProxyGrid2DCollectionProxy::PreStage(const FNDIGpuComputePreStageContext& Context)
{
...
void FFluidNDIProxyGrid2DCollectionProxy::PostStage(const FNDIGpuComputePostStageContext& Context)
{
	if (Context.IsOutputStage())
	{
		FFluidGrid2DCollectionRWInstanceData_RenderThread* ProxyData = SystemInstancesToProxyData_RT.Find(Context.GetSystemInstanceID());
...
void FFluidNDIProxyGrid2DCollectionProxy::PostSimulate(const FNDIGpuComputePostSimulateContext& Context)
{
	FFluidGrid2DCollectionRWInstanceData_RenderThread* ProxyData = SystemInstancesToProxyData_RT.Find(Context.GetSystemInstanceID());
	...
	if (Context.IsFinalPostSimulate())
	{
		...
		if (FFluidNDIProxyGrid2DCollectionProxy* OtherGrid3DProxy = static_cast<FFluidNDIProxyGrid2DCollectionProxy*>(ProxyData->OtherProxy))
		{
			FFluidGrid2DCollectionRWInstanceData_RenderThread& OtherProxyData = OtherGrid3DProxy->SystemInstancesToProxyData_RT.FindChecked(Context.GetSystemInstanceID());
...
FIntVector FFluidNDIProxyGrid2DCollectionProxy::GetElementCount(FNiagaraSystemInstanceID SystemInstanceID) const
{
	if (const FFluidGrid2DCollectionRWInstanceData_RenderThread* ProxyData = SystemInstancesToProxyData_RT.Find(SystemInstanceID))
	{
		// support a grid reader acting as an iteration source
		if (ProxyData->OtherProxy != nullptr)
		{
			FFluidNDIProxyGrid2DCollectionProxy* OtherGrid2DProxy = static_cast<FFluidNDIProxyGrid2DCollectionProxy*>(ProxyData->OtherProxy);
			const FFluidGrid2DCollectionRWInstanceData_RenderThread* OtherProxyData = OtherGrid2DProxy->SystemInstancesToProxyData_RT.Find(SystemInstanceID);
