...
#include "FluidNiagaraSimStage.generated.h"

class UNiagaraScript;

UCLASS(meta = (DisplayName = "Fluid Generic Simulation Stage"))
class FLUIDDYNAMIC_API UFluidNiagaraSimulationStageGeneric : public UNiagaraSimulationStageBase
{
	GENERATED_BODY()
