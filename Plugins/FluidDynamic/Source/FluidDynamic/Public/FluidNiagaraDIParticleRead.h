...
#include "FluidNiagaraDIParticleRead.generated.h"

DECLARE_LOG_CATEGORY_EXTERN(LogFluidPRNiagara, Log, Verbose);
DEFINE_LOG_CATEGORY(LogFluidPRNiagara);

UCLASS(EditInlineNew, Category = "FluidDynamic", meta = (DisplayName = "Fluid Particle Attribute Reader"))
class FLUIDDYNAMIC_API UFluidNiagaraDIParticleRead : public UNiagaraDataInterfaceRWBase
{
