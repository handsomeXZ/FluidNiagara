...
#include "FluidNiagaraDI_RT2D.generated.h"
DECLARE_LOG_CATEGORY_EXTERN(LogFluidFrid2DNiagara, Log, Verbose);
DEFINE_LOG_CATEGORY(LogFluidFrid2DNiagara);

class FNiagaraSystemInstance;
class UTextureRenderTarget2D;


struct FFluidRenderTarget2DRWInstanceData_GameThread
{
	FFluidRenderTarget2DRWInstanceData_GameThread()
	{
...
struct FFluidRenderTarget2DRWInstanceData_RenderThread
{
	FFluidRenderTarget2DRWInstanceData_RenderThread()
	{
#if WITH_EDITORONLY_DATA
		bPreviewTexture = false;
#endif
...
struct FFluidNiagaraDataInterfaceProxyRenderTarget2DProxy : public FNiagaraDataInterfaceProxyRW
{
	FFluidNiagaraDataInterfaceProxyRenderTarget2DProxy() {}
	...
	TMap<FNiagaraSystemInstanceID, FFluidRenderTarget2DRWInstanceData_RenderThread> SystemInstancesToProxyData_RT;
};


UCLASS(EditInlineNew, Category = "FluidDynamic", meta=(DisplayName = "Fluid Render Target 2D", Experimental), Blueprintable, BlueprintType)
class FLUIDDYNAMIC_API UFluidNiagaraDI_RT2D : public UNiagaraDataInterfaceRWBase
{
...
public:
	...
	virtual int32 PerInstanceDataSize()const override { return sizeof(FFluidRenderTarget2DRWInstanceData_GameThread); }
...
protected:
	...
	TMap<FNiagaraSystemInstanceID, FFluidRenderTarget2DRWInstanceData_GameThread*> SystemInstancesToProxyData_GT;
