...
#include "FluidNDIGrid2DCollection.generated.h"
...
struct FFluidGrid2DCollectionRWInstanceData_GameThread
{
	...
	FFluidGrid2DCollectionRWInstanceData_GameThread* OtherInstanceData = nullptr;
...
struct FFluidGrid2DCollectionRWInstanceData_RenderThread
{
	FIntPoint NumCells = FIntPoint(EForceInit::ForceInitToZero);
	int32 NumAttributes = 0;
	FVector2D CellSize = FVector2D::ZeroVector;
...
struct FFluidNDIProxyGrid2DCollectionProxy : public FNiagaraDataInterfaceProxyRW
{
	FFluidNDIProxyGrid2DCollectionProxy() {}
	...
	TMap<FNiagaraSystemInstanceID, FFluidGrid2DCollectionRWInstanceData_RenderThread> SystemInstancesToProxyData_RT;

};

struct FFluidNDIParametersCS_Grid2DCollection : public FNiagaraDataInterfaceParametersCS
{
	DECLARE_TYPE_LAYOUT(FFluidNDIParametersCS_Grid2DCollection, NonVirtual);
...
public:
	...
	virtual int32 PerInstanceDataSize()const override { return sizeof(FFluidGrid2DCollectionRWInstanceData_GameThread); }
...
public:
	...
	TMap<FNiagaraSystemInstanceID, FFluidGrid2DCollectionRWInstanceData_GameThread*>& GetSystemInstancesToProxyData_GT() { return SystemInstancesToProxyData_GT; }
protected:
#if WITH_EDITORONLY_DATA
	...
	void WriteSetSharedHLSL(const FNiagaraDataInterfaceGPUParamInfo& ParamInfo, const FNiagaraDataInterfaceGeneratedFunction& FunctionInfo, int FunctionInstanceIndex, int32 InNumChannels, FString& OutHLSL);
	void WriteGetSharedHLSL(const FNiagaraDataInterfaceGPUParamInfo& ParamInfo, const FNiagaraDataInterfaceGeneratedFunction& FunctionInfo, int FunctionInstanceIndex, int32 InNumChannels, FString& OutHLSL);
	...
	TMap<FNiagaraSystemInstanceID, FFluidGrid2DCollectionRWInstanceData_GameThread*> SystemInstancesToProxyData_GT;
