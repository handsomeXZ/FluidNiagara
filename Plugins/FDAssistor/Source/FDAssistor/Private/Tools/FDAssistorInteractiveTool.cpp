...
#include "FDAssistorInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UFDAssistorInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UFDAssistorInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UFDAssistorInteractiveTool* NewTool = NewObject<UFDAssistorInteractiveTool>(SceneState.ToolManager);
...
UFDAssistorInteractiveToolProperties::UFDAssistorInteractiveToolProperties()
{
...
void UFDAssistorInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UFDAssistorInteractiveTool::Setup()
{
	...
	Properties = NewObject<UFDAssistorInteractiveToolProperties>(this, "Measurement");
...
void UFDAssistorInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UFDAssistorInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UFDAssistorInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UFDAssistorInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UFDAssistorInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UFDAssistorInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UFDAssistorInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UFDAssistorInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UFDAssistorInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
