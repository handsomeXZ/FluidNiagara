...
#include "FDAssistorInteractiveTool.generated.h"


/**
 * Builder for UFDAssistorInteractiveTool
 */
UCLASS()
class FDASSISTOR_API UFDAssistorInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UFDAssistorInteractiveTool
 */
UCLASS(Transient)
class FDASSISTOR_API UFDAssistorInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UFDAssistorInteractiveToolProperties();
...
/**
 * UFDAssistorInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class FDASSISTOR_API UFDAssistorInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UFDAssistorInteractiveToolProperties> Properties;
