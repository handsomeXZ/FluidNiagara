...
#include "FDAssistorContextObject.generated.h"
...
/**
 * Base class for context objects used in the FDAssistor.
 */
UCLASS()
class UVEDITORTOOLS_API UFDAssistorContextObject : public UObject
{
	GENERATED_BODY()
public:
	/**
